...
public class PaginaPersonal {
    public static final Target NOMRE = Target.the("Nombre")
    ...
    public static final Target DIA_NACIMIENTO = Target.the("Dia")
            .located(By.xpath("/html/body/ui-view/main/section/div/div[2]/div/div[2]/div/form/div[1]/div[3]/div[4]/div[2]/div/div[2]/selectl"));
    ...
    public static final Target BOTON = Target.the("Botón de siguiente")
